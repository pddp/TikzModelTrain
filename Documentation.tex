...
\begin{tikzpicture}[scale=0.10]
  ...
  % \def\Angle{90} \draw (25,55) \SwitchTestB{TSwitch}{5214}{C};
  % \def\Angle{90} \draw (35,55) \SwitchTestB{TSwitch}{5214}{R};
  % \def\Angle{90} \draw (25,55) \SwitchTestB{LSwitch}{5203}{S};
  % \def\Angle{90} \draw (35,55) \SwitchTest{LSwitch}{5203}{S};
  % \def\Angle{90} \draw (55,55) \SwitchTest{RSwitch}{5204}{O};
  \def\Angle{90} \draw (75,55) \SwitchTest{XSwitch}{5207}{O};
  % \def\Angle{90} \draw (95,55) \SwitchTest{RSwitch}{5204}{S};
\end{tikzpicture}
\end{verbwrite}
...
\begin{figure}
  ...
  \input{SwitchNames2}
  \end{center}
  \caption{Double wwitches 5214 and three way turnovers}\label{f:switch2}
\end{figure}

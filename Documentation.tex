...
\begin{tabular}{cc}
   \includegraphics[width=0.2\linewidth]{img/mm5142.jpg} & 5154 (right)\\
\end{tabular}
...
Switch layout and labels is illustrated in \figurename~\ref{f:switch0}

\begin{figure}
  \begin{center}
  {\input{SwitchNames}}
  \end{center}
  \caption{Switches}\label{f:switch0}
\end{figure}

...
\begin{tikzpicture}[scale=0.10]
  \def\Angle{90}
  \draw (05,55) \SwitchTest{LCSwitch}{5141}{O};

  \def\Angle{90}
  \draw (15,55) \SwitchTest{LCSwitch}{5141}{C};

  \def\Angle{90}
  \draw (25,55) \SwitchTest{LCSwitch}{5141}{S};

  \def\Angle{90}
  \draw (55,55) \SwitchTest{RCSwitch}{5142}{O};

  \def\Angle{90}
  \draw (85,55) \SwitchTest{RCSwitch}{5142}{C};

  \def\Angle{90}
  \draw (95,55) \SwitchTest{RCSwitch}{5142}{S};
\end{tikzpicture}
\end{verbwrite}
...
\begin{tikzpicture}[scale=0.10]
  \def\Angle{90}
  \draw (05,55) \SwitchTest{LSwitch}{5203}{O};

  \def\Angle{90}
  \draw (15,55) \SwitchTest{LSwitch}{5203}{C};

  \def\Angle{90}
  \draw (35,55) \SwitchTest{LSwitch}{5203}{S};

  \def\Angle{90}
  \draw (55,55) \SwitchTest{RSwitch}{5204}{O};

  \def\Angle{90}
  \draw (75,55) \SwitchTest{RSwitch}{5204}{C};

  \def\Angle{90}
  \draw (95,55) \SwitchTest{RSwitch}{5204}{S};
  ...
  % \def\Angle{90}
  % \draw (75,55) 
  %   \RSwitch[W2][O]{5118} % Switch named W2
  % ;

  % \draw (S1O) node {O};
  % \draw (S1C) node[above] {C};
  % \draw (S1S) node[above] {S};

  % \draw (S2O) node[above] {O};
  % \draw (S2C) node[above] {C};
  %\draw (S2S) node[above] {S};

  % \draw (S3O) node[above] {O};
  %\draw (S3C) node[above] {C};
  %\draw (S3S) node[above] {S};

  % \draw (W1O) node[above] {O};
  % \draw (W1C) node[above] {C};
  % \draw (W1S) node[above] {S};

  % \draw (W2O) node[above] {O};
  % \draw (W2C) node[above] {C};
  % \draw (W2S) node[above] {S};
\end{tikzpicture}
\end{verbwrite}
...
Three tracks are layed here: first a straight track upwards, then comes the switch with
different points to join, then comes agein a straight track.
...
An example for curved switches is shown in \figurename~\ref{f:switch1}

\begin{figure}
  \begin{center}
  {\input{SwitchExample1}}
  \end{center}
  \caption{Example for switches}\label{f:switch1}
\end{figure}

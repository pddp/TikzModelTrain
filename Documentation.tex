...
\begin{tikzpicture}[scale=0.16]
  \def\Angle{00}
  \draw (5,55) coordinate (Start)    % start layouting tracks here
    \Straight{5110} \Straight{5109}
    \Straight{5106} \Straight{5106}
    \LSwitch[W1][S]{5137L} \Straight{5129} ;
  ...
  \RestPosAngle{W2S}
  \draw (W2S) \Straight{5129} \Straight{5106} \Straight{5106} ;

  \RestPosAngle{X1S}
  \draw (X1S) \Straight{5129} \Straight{5106} ;

  \RestPosAngle{X1O}
  \draw (X1O) \Straight{5129} \Straight{5106} ;
\end{tikzpicture}
\egroup
\end{verbwrite}
...
\begin{figure}
  ...
  {\input{SwitchLayout1}}
  \end{center}
  \caption{Example for layout of switches}\label{f:switchlayout1}
\end{figure}
...
\begin{figure}
  ...
  {\input{SwitchLayout2}}
  \end{center}
  \caption{Example for layout of switches}\label{f:switchlayout2}
\end{figure}
